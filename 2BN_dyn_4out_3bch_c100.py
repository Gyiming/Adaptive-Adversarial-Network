...
from models.cifar10.resnet_dynf_4out_3 import ResNet34OAT
...
save_folder = os.path.join('./2BNDYN_4out', 'cifar10', model_str, '%s_%s_%s_%s' % (attack_str, opt_str, decay_str, lambda_str))
print(save_folder)
...
for epoch in range(start_epoch, args.epochs):
    ...
    if eval_this_epoch:
        ...
        '''
        val_str = 'Epoch %d | Validation | Time: %.4f | lr: %s | SA: %.4f, RA1: %.4f, RA2: %.4f' % (
