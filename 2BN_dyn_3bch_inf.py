...
model = model_fn(num_classes = 10, use2BN = True, FiLM_in_channels=FiLM_in_channels).cuda()
...
save_folder = '/localdisk2/2BNDYN/cifar10/ResNet34OAT-2BN/diffl1_3bn_6_12'
print(save_folder)
...
label_adv = np.load('./testimg/joint_tpgd15_3.npy')
