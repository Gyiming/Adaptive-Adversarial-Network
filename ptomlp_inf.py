...
def main():
    ...
    normal_vector_vali = vectorprocess('/u/ygan10/Once-for-All-Adversarial-Training/metrics/c100_tpgd8_test.csv')
    ...
    save_folder2 = '/u/ygan10/Ptolemy/joint/cifar100/ResNet34OAT-2BN/loss1/'
    model.load_state_dict(torch.load(os.path.join(save_folder2,'joint_pto.pth')),True)
    ...
    print(val_accs.avg)
    np.save('./testimg/c100_joint_tpgd8.npy',x)
