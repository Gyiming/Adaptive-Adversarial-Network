...
model = model_fn(use2BN=False, FiLM_in_channels=FiLM_in_channels, num_classes = 100).cuda()
model = torch.nn.DataParallel(model)

# mkdirs:
save_folder = '/localdisk2/2BNDYN/cifar100/ResNet34OAT-2BN/diffl1_3bn_6_12/'
print(save_folder)
...
label_adv = np.load('./testimg/c100_joint_tpgd_ori3.npy')
