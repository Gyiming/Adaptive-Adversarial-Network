...
from dynamic_models.dy_resnet import r34dyn1 as dy1_resnet34
...
parser.add_argument('--epochs', '-e', default=720, type=int, help='number of total epochs to run')
...
parser.add_argument('--lr', default=0.11, type=float, help='initial learning rate')
